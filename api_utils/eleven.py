...
def getVoices(api_key="e6b964fdf54c670d55239f37dc2bc236"):
...
def getCharactersFromKey(key="e6b964fdf54c670d55239f37dc2bc236"):
...
def generateVoice(text, character, project, stability=0.2, clarity=0.1, api_key="e6b964fdf54c670d55239f37dc2bc236"):
    if not api_key:
